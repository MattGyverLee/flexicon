...
**Date:** 2026-09-24  
**Branch:** fix/303-overlay-closeout-sep24 from origin/main
...
Issue #303 remained open because inherited **reorder** methods still inherited from
``PossibilityItemOperations`` without an honest failure mode.
