        ...
        if test_obj:
            ...
            if hasattr(project.Wordforms, "SetName"):
                try:
                    ...
                    old_name = (
                        project.Wordforms.GetName(test_obj) if hasattr(project.Wordforms, "GetName") else test_name
                    )
                    project.Wordforms.SetName(test_obj, new_name)
                    updated_name = (
                        project.Wordforms.GetName(test_obj) if hasattr(project.Wordforms, "GetName") else new_name
                    )
