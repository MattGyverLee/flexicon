        ...
        if test_obj:
            ...
            if hasattr(project.WfiAnalyses, "SetName"):
                try:
                    ...
                    old_name = (
                        project.WfiAnalyses.GetName(test_obj) if hasattr(project.WfiAnalyses, "GetName") else test_name
                    )
                    project.WfiAnalyses.SetName(test_obj, new_name)
                    updated_name = (
                        project.WfiAnalyses.GetName(test_obj) if hasattr(project.WfiAnalyses, "GetName") else new_name
                    )
