        ...
        if test_obj:
            ...
            if hasattr(project.Confidence, "SetName"):
                try:
                    ...
                    old_name = (
                        project.Confidence.GetName(test_obj) if hasattr(project.Confidence, "GetName") else test_name
                    )
                    project.Confidence.SetName(test_obj, new_name)
                    updated_name = (
                        project.Confidence.GetName(test_obj) if hasattr(project.Confidence, "GetName") else new_name
                    )
