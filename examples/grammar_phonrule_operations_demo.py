        ...
        if test_obj:
            ...
            if hasattr(project.PhonRules, "SetName"):
                try:
                    ...
                    old_name = (
                        project.PhonRules.GetName(test_obj) if hasattr(project.PhonRules, "GetName") else test_name
                    )
                    project.PhonRules.SetName(test_obj, new_name)
                    updated_name = (
                        project.PhonRules.GetName(test_obj) if hasattr(project.PhonRules, "GetName") else new_name
                    )
